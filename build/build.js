...
exports.Table = exports.TableRow = exports.EmptyRow = undefined;

var _wrapper = require('./wrapper.hbs');

var _wrapper2 = _interopRequireDefault(_wrapper);

var _row = require('./row.hbs');

var _row2 = _interopRequireDefault(_row);

var _empty = require('./empty.hbs');

var _empty2 = _interopRequireDefault(_empty);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var EmptyRow = exports.EmptyRow = Marionette.ItemView.extend({
  template: _empty2.default,
  tagName: 'tr'
});

var TableRow = exports.TableRow = Marionette.ItemView.extend({
  template: _row2.default,
  tagName: 'tr'
});

var Table = exports.Table = Marionette.CompositeView.extend({
  template: _wrapper2.default,
  tagName: 'table',
...
},{"./empty.hbs":21,"./row.hbs":23,"./wrapper.hbs":24}],23:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "";
...
Lib.Table = _Table.Table;
Lib.TableRow = _Table.TableRow;
